...
if old not in text:
    raise SystemExit('headwear acceptance anchor missing')
text = text.replace(old, new, 1)
path.write_text(text)

Path('test/headwearPublicationV5.test.js').write_text(r'''import test from "node:test";
